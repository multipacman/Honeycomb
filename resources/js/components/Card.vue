<template>
    <div
        class="group shadow-card bg-white rounded-sm p-2 cursor-pointer text-sm hover:bg-gray-100 mb-2 flex justify-between"
    >
        <div>
            {{ card.title }}
        </div>
        ...
        >
            <div class="text-gray-400 pr-2 hover:text-blue-600">E</div>
            <div class="text-gray-400 hover:text-red-600" @click="cardDelete">
                D
            </div>
        </div>
    </div>
